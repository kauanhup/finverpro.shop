...
try {
   ...
   $stmt = $conn->prepare("SELECT banco, client_id, client_secret, status, webhook_url FROM gateway");
   $stmt->execute();
                  ...
                  <div class="row align-items-center">
                     <div class="col-md-12">
                        <ul class="breadcrumb">
                           ...
                           <li class="breadcrumb-item" aria-current="page">Configuração de Pagamento</li>
                        </ul>
                     </div>
                     <div class="col-md-12">
                        <div class="page-header-title">
                           <h2 class="mb-0">Gateway</h2>
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="col-md-6 mb-4">
                     <div class="card">
                        <div class="card-header">
                           <h5><?= htmlspecialchars($gateway['banco']) ?></h5>
                        </div>
                        <div class="card-body">
                           <form method="post" action="salvar.php">
                              <input type="hidden" name="banco" value="<?= htmlspecialchars($gateway['banco']) ?>">
                              <div class="mb-3">
                                 ...
                                 <input
                                    ...
                                    class="form-control"
                                    name="client_id"
                                    value="<?= htmlspecialchars($gateway['client_id']) ?>"
                                    placeholder="Seu Cliente ID" />
                              </div>
                              <div class="mb-3">
                                 ...
                                 <input
                                    ...
                                    class="form-control"
                                    name="client_secret"
                                    value="<?= htmlspecialchars($gateway['client_secret']) ?>"
                                    placeholder="Seu Cliente Secret" />
                              </div>
                              <!-- ✅ NOVO CAMPO: Webhook URL -->
                              <div class="mb-3">
                                 ...
                                 <input
                                    ...
                                    class="form-control"
                                    name="webhook_url"
                                    value="<?= htmlspecialchars($gateway['webhook_url']) ?>"
                                    placeholder="https://seudominio.com/gate/webhook.php" />
                              </div>
                              <div class="mb-3">
                                 <label class="form-label">Status</label>
                                 <select name="status" class="form-control">
                                    <option value="true" <?= $gateway['status'] === 'true' ? 'selected' : '' ?>>True</option>
                                    <option value="false" <?= $gateway['status'] === 'false' ? 'selected' : '' ?>>False</option>
                                 </select>
                              </div>
