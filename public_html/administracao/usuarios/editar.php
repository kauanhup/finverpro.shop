<?php
   ...
   if (isset($_GET['id'])) {
       ...
       $sql = "SELECT u.id, u.telefone, u.saldo, u.saldo_comissao,
               (SELECT COUNT(*) FROM usuarios WHERE referencia_convite = u.codigo_referencia) AS convidados,
               (SELECT SUM(p.valor_investimento) FROM investidores i JOIN produtos p ON i.produto_investido = p.id WHERE i.id_usuario = u.id) AS total_investido,
               (SELECT COUNT(*) FROM investidores WHERE id_usuario = u.id) AS produtos,
               (SELECT SUM(valor) FROM pagamentos WHERE user_id = u.id AND status = 'Aprovado') AS depositos,
               (SELECT SUM(valor) FROM saques WHERE user_id = u.id AND status = 'Aprovado') AS saques
               FROM usuarios u WHERE u.id = :id"; // Filtra pela ID do usuário
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-4">
                                 <div class="mb-3">
                                    ...
                                    <input type="number" name="saldo" class="form-control" value="<?= htmlspecialchars($usuario['saldo']) ?>" required>
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="mb-3">
                                    <label class="form-label">Saldo Comissão</label>
                                    <input type="number" name="saldo_comissao" class="form-control" value="<?= htmlspecialchars($usuario['saldo_comissao']) ?>" required>
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="mb-3">
                              ...
                              <div class="col-md-4">
                                 <div class="mb-3">
                                    ...
                                    <input type="number" name="total_investido" class="form-control" value="<?= htmlspecialchars($usuario['total_investido']) ?>" disabled>
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="mb-3">
                              ...
                              <div class="col-md-4">
                                 <div class="mb-3">
                                    <label class="form-label">Quantidade de Depósitos</label>
                                    <input type="number" name="depositos" class="form-control" value="<?= htmlspecialchars($usuario['depositos']) ?>" disabled>
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="mb-3">
                                    <label class="form-label">Quantidade de Saques</label>
                                    <input type="number" name="saques" class="form-control" value="<?= htmlspecialchars($usuario['saques']) ?>" disabled>
                                 </div>
                              </div>
                           </div>
      ...
      <footer class="pc-footer">
         <div class="footer-wrapper container-fluid">
            <div class="row">
               <div class="col my-1">
                  <p class="m-0"
                     >Feito com muito &#9829; por <a href="https://t.me/seemniick" target="_blank">Semnick</a></p
                     >
               </div>
               <div class="col-auto my-1">
                  <ul class="list-inline footer-link mb-0">
                     <li class="list-inline-item"><a href="../../inicio">Inicio</a></li>
                     <li class="list-inline-item"><a href="https://t.me/seemniick" target="_blank">Support</a></li>
                  </ul>
               </div>
            </div>
         </div>
