...
// Consultar a tabela "bonus"
$sql = "SELECT id, codigo, qnt_usos, qnt_usados, data_vencimento, saldo, data_criacao FROM bonus";
$stmt = $conn->prepare($sql);
$stmt->execute();
          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Configuração de Produtos</li>
              </ul>
            </div>
            <div class="col-md-12">
          ...
          <div class="card table-card">
            <div class="card-header">
              <div class="d-sm-flex align-items-center justify-content-between">
                <h5 class="mb-3 mb-sm-0">Tenha controle de todos os códigos da plataforma.</h5>
                <div>
                  <a href="../codigos/criar.html" class="btn btn-primary">Criar Código</a>
                </div>
              </div>
            </div>
    ...
    <tbody>
        <?php foreach ($bonuses as $bonus): ?>
            <tr>
                ...
                <td><?php echo $bonus['codigo']; ?></td>
                <td><?php echo $bonus['qnt_usos']; ?></td>
                <td><?php echo $bonus['qnt_usados']; ?></td>
                <td><?php echo date('d-m-Y H:i:s', strtotime($bonus['data_vencimento'])); ?></td>
                <td><?php echo 'R$ ' . number_format($bonus['saldo'], 2, ',', '.'); ?></td>
                <td><?php echo date('d-m-Y H:i:s', strtotime($bonus['data_criacao'])); ?></td>
                <td>
                    <a href="#" class="avtar avtar-xs btn-link-secondary delete-button" data-id="<?php echo $bonus['id']; ?>">
...
document.querySelectorAll('.delete-button').forEach(button => {
    button.addEventListener('click', function(e) {
        ...
        const id = this.getAttribute('data-id'); // Obtém o ID do bonus
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // Se confirmado, faça a chamada para a exclusão
                window.location.href = 'delete.php?id=' + id; // Direciona para o script de exclusão
            }
        });
    });
});
